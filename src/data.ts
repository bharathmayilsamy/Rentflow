...
export const initialTenants: Tenant[] = [
  { id: 't1', name: 'Rahul Sharma', email: 'rahul@email.com', phone: '9876543210', propertyId: 'p1', room: 'A-101', rent: 15000, deposit: 30000, leaseStart: '2024-01-01', leaseEnd: '2025-12-31', idProof: 'Aadhar - XXXX1234', emergencyContact: '9876543211', notes: 'Prefers ground floor', status: 'Active', avatarColor: '#6366f1' },
  { id: 't2', name: 'Priya Patel', email: 'priya@email.com', phone: '9876543212', propertyId: 'p1', room: 'A-202', rent: 15000, deposit: 30000, leaseStart: '2024-03-01', leaseEnd: '2025-02-28', idProof: 'PAN - XXXX5678', emergencyContact: '9876543213', notes: '', status: 'Active', avatarColor: '#ec4899' },
  { id: 't3', name: 'Amit Kumar', email: 'amit@email.com', phone: '9876543214', propertyId: 'p2', room: 'B-12', rent: 8000, deposit: 16000, leaseStart: '2024-06-01', leaseEnd: '2025-05-31', idProof: 'Aadhar - XXXX9012', emergencyContact: '9876543215', notes: 'Night shift worker', status: 'Active', avatarColor: '#22c55e' },
  { id: 't4', name: 'Sneha Reddy', email: 'sneha@email.com', phone: '9876543216', propertyId: 'p3', room: 'H-5', rent: 6000, deposit: 12000, leaseStart: '2024-02-01', leaseEnd: '2024-12-31', idProof: 'Passport - XXXX3456', emergencyContact: '9876543217', notes: 'Student', status: 'Notice', avatarColor: '#f97316' },
  { id: 't5', name: 'Vikram Singh', email: 'vikram@email.com', phone: '9876543218', propertyId: 'p4', room: 'Main', rent: 25000, deposit: 50000, leaseStart: '2024-04-01', leaseEnd: '2026-03-31', idProof: 'DL - XXXX7890', emergencyContact: '9876543219', notes: 'Family of 4', status: 'Active', avatarColor: '#3b82f6' },
  { id: 't6', name: 'Deepa Nair', email: 'deepa@email.com', phone: '9876543220', propertyId: 'p2', room: 'B-15', rent: 8000, deposit: 16000, leaseStart: '2023-09-01', leaseEnd: '2024-08-31', idProof: 'Aadhar - XXXX2345', emergencyContact: '9876543221', notes: '', status: 'Inactive', avatarColor: '#8b5cf6' },
];
